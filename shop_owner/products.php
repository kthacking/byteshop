    ...
    <div class="container">
        <div class="header">
            <div>
                ...
                <span class="security-badge">🔒 Owner ID: <?php echo $owner_id; ?> | Market ID: <?php echo $market_id; ?></span>
            </div>
            <div class="user-info">
                ...
                <div class="products-grid">
                    <?php foreach ($products as $product): ?>
                        <div class="product-card">
                            ...
                            <?php else: ?>
                                <div class="product-image" style="display: flex; align-items: center; justify-content: center; background: #f7fafc; color: #cbd5e0;">
                            ...
                            <div class="product-info">
                                ...
                                <?php if ($product['has_details']): ?>
                                    <p class="product-details"><?php echo htmlspecialchars(substr($product['details'], 0, 100)); ?>...</p>
                                <?php endif; ?>
                                ...
                                <div class="product-actions">
                                    ...
                                    <button class="btn btn-danger" onclick="deleteProduct(<?php echo $product['product_id']; ?>, '<?php echo htmlspecialchars($product['product_name']); ?>')">
                                        Delete
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="details" placeholder="Enter product description, features, specifications..."></textarea>
                </div>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Product Details (Optional)</label>
                    <textarea name="details" id="edit_details" placeholder="Enter product description, features, specifications..."></textarea>
                </div>
